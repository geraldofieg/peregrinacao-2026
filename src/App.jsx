  ...
  return(
    <div style={{ padding:"20px 16px" }}>
      ...
      <div style={{ background:`linear-gradient(150deg,${C.navy},${C.navyL})`, borderRadius:20, padding:"22px 18px", border:`2px solid ${C.gold}`, marginBottom:16 }}>
        ...
        <div style={{ background:"rgba(255,255,255,0.1)", borderRadius:14, padding:"16px 14px", marginBottom:12 }}>
          ...
          <div style={{ marginTop:10, background:"rgba(232,168,32,0.2)", borderRadius:10, padding:"12px 14px", border:`1px solid ${C.gold}` }}>
            <div style={{ color:C.goldL, fontFamily:"'Cinzel',serif", fontSize:17, fontWeight:700 }}>
              🎟️ 4 acessos gratuitos por ano
            </div>
            <div style={{ color:"rgba(255,255,255,0.65)", fontSize:15, marginTop:4 }}>
              Nunca utilizados — 4 acessos disponíveis
            </div>
          </div>
          <div style={{ marginTop:10, background:"rgba(255,255,255,0.08)", borderRadius:10, padding:"12px 14px" }}>
            <div style={{ color:"rgba(255,255,255,0.8)", fontSize:15, lineHeight:1.7 }}>
              📱 Como usar: baixe o app <strong>Visa Airport Companion</strong> (iOS ou Android), cadastre o cartão e apresente o QR Code na entrada da sala.
            </div>
          </div>
        </div>

        {/* Cartão do padrasto — pendente */}
        <div style={{ background:"rgba(183,28,28,0.2)", borderRadius:12, padding:"12px 14px", border:"1px solid rgba(183,28,28,0.45)" }}>
          <div style={{ color:"#FF8A80", fontSize:15, lineHeight:1.65 }}>
            ⚠️ <strong>Cartão do padrasto:</strong> benefícios ainda sendo levantados. Informação será adicionada em breve.
          </div>
        </div>
      </div>
      ...
      <Card style={{ background:"#E8F5E9", border:`1px solid #A5D6A7` }}>
        <div style={{ fontFamily:"'Cinzel',serif", fontSize:15, fontWeight:700, color:C.green, marginBottom:8 }}>
          💡 Como aproveitar melhor os 4 acessos
        </div>
        <div style={{ ...T.body, fontSize:16, lineHeight:1.75 }}>
          A rota passa por <strong>3 aeroportos com salas disponíveis</strong> (GRU, LIS e FCO). Com 4 acessos, é possível usar em 2 aeroportos com 2 acessos cada, ou distribuir livremente. Sugestão: aproveitar em <strong>Guarulhos</strong> (espera longa antes do voo internacional) e em <strong>Roma</strong> na volta (FCO tem 5 opções de sala).
        </div>
      </Card>
      ...
      {LOUNGES.map((ap, ai) => (
        <Card key={ai}>
          <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:4 }}>
            <span style={{ background:C.navy, color:C.goldL, borderRadius:8, padding:"4px 12px", fontFamily:"'Cinzel',serif", fontSize:15, fontWeight:700 }}>
              {ap.code}
            </span>
          ...
          {ap.salas.map((sala, si) => {
            ...
            return (
              <div
                ...
                style={{ borderRadius:12, border:`1.5px solid ${open ? C.gold : C.creamD}`, marginBottom:8, overflow:"hidden", cursor:"pointer" }}
              >
      ...
      <Card style={{ background:C.creamD, border:"none", textAlign:"center" }}>
        <div style={{ ...T.body, fontSize:15, lineHeight:1.75 }}>
          ℹ️ Salas acessíveis pelo programa <strong>Visa Airport Companion</strong> (DragonPass). Confirme disponibilidade no app antes de cada voo.
        </div>
      </Card>
    </div>
  );
